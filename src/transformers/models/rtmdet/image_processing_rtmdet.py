...
from ..detr.image_processing_detr import get_resize_output_image_size,get_image_size_for_max_height_width,safe_squeeze,normalize_annotation,get_max_height_width,make_pixel_mask
...
class RTMDetImageProcessor(BaseImageProcessor):
    r"""
