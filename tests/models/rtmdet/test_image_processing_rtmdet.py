...
if is_vision_available():
    ...
    from transformers import RTMDetImageProcessor

if is_torch_available():
    import torch


class RTMDetImageProcessingTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=4,
        ...
        self.size = size if size is not None else {"max_height": 640, "max_width": 640}
    ...
    def get_expected_values(self, image_inputs, batched=False):
        #return self.size["max_height"], self.size["max_width"]
        """
        ...
        if not batched:
            ...
            max_width = self.size["max_width"]
            max_height = self.size["max_height"]
...
@require_torch
@require_vision
class RTMDetImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    image_processing_class = RTMDetImageProcessor if is_vision_available() else None

    def setUp(self):
        super().setUp()
        self.image_processor_tester = RTMDetImageProcessingTester(self)
    ...
    def test_image_processor_from_dict_with_kwargs(self):
        ...
        self.assertEqual(image_processor.size, {"max_height": 640, "max_width": 640})
    ...
    def test_valid_coco_detection_annotations(self):
        ...
        # encode them
        image_processing = RTMDetImageProcessor.from_pretrained("PekingU/rtdetr_r50vd")
    ...
    def test_batched_coco_detection_annotations(self):
        ...
        image_processing = RTMDetImageProcessor()
